...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference("Poll.count") do
      post polls_url, params: { poll: { ends_at: @poll.ends_at, opened: @poll.opened, summary: @poll.summary, title: @poll.title } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { ends_at: @poll.ends_at, opened: @poll.opened, summary: @poll.summary, title: @poll.title } }
